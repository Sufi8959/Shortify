      ...
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          <motion.h1
            ...
            className="font-bold font-roboto text-slate-800 md:text-5xl sm:text-4xl text-2xl   md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full"
          >
            Shortify Simplifies URL Shortening For Efficient Sharing.
          </motion.h1>
          <p className="text-slate-700 text-md my-5 italic">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="cursor-pointer bg-gradient-to-l from-blue-500 to-rose-500 border-btnColor border w-40 text-btnColor rounded-md  py-2 text-white"
            >
              Create Short Link
            </motion.button>
          </div>
